...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    server: {
      // Temporarily disable CSP for development to allow API calls to localhost
      // headers: {
      ...
      //     font-src 'self';
      //     connect-src 'self' http://localhost:8000 http://localhost:5173 https://vercel-frontend-pi-steel.vercel.app https://*.clerk.accounts.dev https://*.clerk.accounts.workers.dev https://*.clerk.dev https://*.clerk.vercel.com;
